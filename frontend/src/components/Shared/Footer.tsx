        ...
        <div
            ...
            <div className='flex flex-col w-full'>
                <div className='flex justify-center items-center'>
                    <h2 className="text-xl">Tlalli</h2>
                    <FaGripfire className='w-14 h-6'/> 
                </div>
                <p className='text-center'>Los mejores productos para su pelo.</p>
            </div>
            <div className="flex flex-col w-full">
                <span className="text-xl text-center">Encuentra nuestras redes sociales</span>
                <div className="flex justify-center">
                    <a className="m-1 hover:text-blue-400 transition ease-in 150ms"
                       href="https://www.linkedin.com/in/miguel-angel-resendiz-d/" target="_blank" rel="noreferrer">
                        <FaLinkedin width={32} height={32}/>
                    </a>
                    <a className="m-1 hover:text-gray-300 transition ease-in 150ms"
                       href="https://github.com/pelosmard" target="_blank" rel="noreferrer">
            ...
            <div className="flex flex-col w-full">
                <span className="text-xl text-center">Obtener Ayuda</span>
            ...
            <div className="flex flex-col w-full">
                <span className="text-xl text-center">Acerca de Tlalli</span>
                <div className="flex flex-col text-sm text-center text-amber-50/90">
